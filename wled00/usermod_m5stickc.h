...
uint32_t lastUpdateTime=0;
  ...
  void loop()
  {
    ...
    if (currentTime > nextUpdateTime)
    {
      ...
      tftSprite.printf("Temp: %.1fC / %.1fC\r\n", M5.Axp.GetTempInAXP192(), avgTemp);
      ...
      tftSprite.printf("USB:   %.2fv %.2fma %d\r\n", M5.Axp.GetVBusVoltage(), M5.Axp.GetVBusCurrent(), M5.Axp.GetInputPowerStatus());
